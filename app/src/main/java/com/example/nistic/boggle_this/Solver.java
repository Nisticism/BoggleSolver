...
//    	BufferedReader txtReader = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("dictionary.txt")));
//    	File file = new File("C:/Documents/boggleDictionary.txt");
//    	try{
//    		file.createNewFile();
//            FileWriter fw = new FileWriter(file);
//            while(txtReader.readLine() != null ){
//               fw.write(txtReader.readLine());
//            }
//            txtReader.close();
//            fw.close();
//        }catch(IOException e){
...
//        }
//    }
    public String dictionaryCreation(String filename, Context mycontext) throws IOException {
